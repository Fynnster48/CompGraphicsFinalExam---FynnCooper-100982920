Shader "Fynn/URP_LightingWithTransparency"

{
    Properties
    {
        ...
        _RimIntensity ("Rim Intensity", Float) = 3  // Strength of the rim lighting
        _FresnelPower ("Fresnel Power", Range(1, 5)) = 2.0  // Power for the fresnel rim effect
        _Transparency ("Transparency", Range(0, 2)) = 0.5  // Transparency control
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // Combine the texture color, fresnel rim
